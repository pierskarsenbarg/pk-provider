...
namespace Pulumi.PkProvider
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.PkProvider.version.txt");
    ...
    internal sealed class PkProviderResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PkProviderResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
