PROJECT_NAME := Pulumi pk-provider Resource Provider

PACK             := pk-provider
PACKDIR          := sdk
PROJECT          := github.com/pierskarsenbarg/pk-provider
NODE_MODULE_NAME := @pulumi/pk-provider
NUGET_PKG_NAME   := Pulumi.pk-provider
